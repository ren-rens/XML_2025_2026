...
## Задача 4: 
За DTD граматиката, намираща се на адрес: (http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd)[тук], създайте XML документ. Включете в XML документа дадената DTD граматика като публична и го валидирайте спрямо нея.
